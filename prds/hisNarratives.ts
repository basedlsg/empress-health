...
/**
 * HRT overlay copy injected before Domain 1 (Vasomotor) and Domain 8 (GU/Sexual)
 * narratives whenever the user reports active hormone therapy.
 */
export const MHT_OVERLAY: Record<number, string> = {
  1: "IMPORTANT \u2014 HRT ACTIVE: Your scores in this domain reflect your symptom experience while on hormone therapy. HRT is effectively managing your vasomotor symptoms, which means your score in this area represents your treated state, not your underlying untreated biology. If you were to stop HRT, your vasomotor domain score would likely be lower. This is not a limitation of the assessment \u2014 it reflects the clinical benefit of your current treatment.",
  8: "IMPORTANT \u2014 HRT ACTIVE: Your genitourinary and sexual health scores may be influenced by your current hormone therapy. Systemic HRT partially addresses GSM, though local vaginal estrogen is often required in addition to systemic therapy for complete genitourinary protection. Discuss with your provider whether your current regimen fully addresses Domain 8 symptoms.",
}
...
export const TEMPLATES: Record<NarrativeKey, NarrativeModule> = {
  ...
  [`3_menopause`]: {
    ...
    low: "Significant cognitive burden at menopause warrants a comprehensive discussion with your healthcare provider. The cognitive window \u2014 initiating effective intervention during or immediately after the menopausal transition \u2014 is now well-established in the neuroprotection literature. Delays in addressing severe cognitive symptoms may limit recovery potential. HRT during this window has the strongest evidence for cognitive protection. Please seek specialist evaluation.",
    flagItems: {},
  },
  [`3_post_menopause`]: {
  ...
  [`6_post_menopause`]: {
    high: "Well-maintained skin, hair, and nail integrity in post-menopause reflects either effective supplementation, HRT benefit on collagen, or natural resilience.",
  ...
  [`8_menopause`]: {
    ...
    moderate: "GSM is developing at menopause \u2014 vaginal dryness, urinary urgency, and sexual changes are all estrogen-receptor driven. Local vaginal estrogen is safe, highly effective, and does not carry the systemic risks of oral HRT. Please discuss with your provider.",
