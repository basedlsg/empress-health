...
function h1(text) {
  return new Paragraph({
    ...
    children: [
      new TextRun({ text, bold: true, color: PLUM, size: 40, font: "Poppins" }),
    ],
  });
}
...
function h2(text) {
  return new Paragraph({
    ...
    children: [
      new TextRun({ text, bold: true, color: PLUM, size: 28, font: "Poppins" }),
    ],
  });
}
...
function pageOne(data) {
  ...
  return [
    ...
    p(
      ...
      { italic: true, color: MUTED, size: 26, spaceAfter: 320, font: "Poppins" },
    ),
    p(
      ...
      paragraphStyles: [
        {
          ...
          next: "Normal",
          quickFormat: true,
          run: { size: 40, bold: true, font: "Poppins", color: PLUM },
        ...
        },
        {
          ...
          next: "Normal",
          quickFormat: true,
          run: { size: 28, bold: true, font: "Poppins", color: PLUM },
