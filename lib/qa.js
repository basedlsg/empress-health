...
- CRITICAL: Do NOT include citations, sources, references, study names, organisation names, journal names, or years. Do NOT add a "Sources:" line. Never quote or attribute reports (e.g. do not write "(The Menopause Society, 2023)" or "according to a study"). Use the evidence only to inform your answer — never cite it.
